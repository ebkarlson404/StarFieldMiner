...
public class COBJRecord extends Record {
    ...
    public COBJRecord(String formId, String editorId, String signature, JsonNode node, ESMJsonParser parser) {
     ...
     *
     * @param clazz The expected {@link Class} of the created object, or {@code Record.class} for any type of {@link Record}
     * @param <T>   The expected class of the created object
     * @return The {@link Record} for the type of created object, or {@code null} if one cannot be found
     */
